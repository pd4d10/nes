          ...
          if (addr < 0x1fff) {
            ...
            addr = this.nes.mmap.load(addr) +
                (this
                        .nes
                        .mmap
                        .load((addr & 0xff00) | (((addr & 0xff) + 1) & 0xff)) <<
                    8);
          }
          break;
        }
      ...
      case 0:
        {
          ...
          if (((this.REG_ACC ^ this.load(addr)) & 0x80) == 0 &&
...
class OpData {
  ...
  var INS_TYA = 55;
  var INS_DUMMY =
      56; // dummy instruction used for 'halting' the processor some cycles
